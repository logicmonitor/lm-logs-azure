...
wget -q --backups=2 https://raw.githubusercontent.com/pmelkowski/lm-logs-azure/vm-configuration/vm-config/lad_protected_settings.json
...
wget -q --backups=2 https://raw.githubusercontent.com/pmelkowski/lm-logs-azure/vm-configuration/vm-config/lad_public_settings.json
